...
| Classes | Methods              | Scenario                               | Outputs        |
|---------|----------------------|----------------------------------------|----------------|
|`Basket` | `sumBasket(basket)`  | list total cost of items in my basket  | int            |
...
| Classes | Methods              | Scenario                 | Outputs      |
|---------|----------------------|--------------------------|--------------|
|`Basket` | `sumBagel(bagel)`  | list cost of chosen bagel  | int          |
...
| Classes | Methods                | Scenario                        | Outputs        |
|---------|------------------------|---------------------------------|----------------|
|`Basket` | `bagelFilling(bagel)`  | choose filling for chosen bagel | String         |
...
| Classes | Methods              | Scenario           | Outputs             |
|---------|----------------------|--------------------|---------------------|
|`Basket` | `costFilling()`  | list price of filling  | List<int>           |
...
| Classes | Methods            | Scenario                          | Outputs        |
|---------|--------------------|-----------------------------------|----------------|
|`Basket` | `inStock(basket)`  | check if order items are in stock | bool           |