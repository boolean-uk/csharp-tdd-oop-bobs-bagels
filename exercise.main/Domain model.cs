...
namespace exercise.main
{
   ...
   class Receipt()
       ...
       method float Total(basket)
           calculates the total price of the basket, output float Total
   ...
   class Item(price, name, sku)
       private float price
       private string nameVariant
       private string SKU

       method void getSKU
       method void getnameVariant
